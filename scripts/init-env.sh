...
WHISPER_OOM_FALLBACK="$(existing_env_value WHISPER_OOM_FALLBACK "cpu")"
WHISPER_WORKER_MODE="$(existing_env_value WHISPER_WORKER_MODE "on_oom")"
WHISPER_STRICT_RESOURCE_CHECK="$(existing_env_value WHISPER_STRICT_RESOURCE_CHECK "false")"
...
WHISPER_OOM_FALLBACK=$WHISPER_OOM_FALLBACK
WHISPER_WORKER_MODE=$WHISPER_WORKER_MODE
WHISPER_STRICT_RESOURCE_CHECK=$WHISPER_STRICT_RESOURCE_CHECK
